        ...
        <div className="space-y-4">
          <div className="bg-surface border border-border rounded-lg p-5">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select value={statut} onChange={(e) => setStatut(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]">
          ...
          <div className="bg-surface border border-border rounded-lg p-5">
            ...
            <div className="grid grid-cols-2 gap-3 mt-2">
              <div><div className="text-xs text-sub">Frais sortie usine</div><input type="number" value={fraisSortieUsine} onChange={(e) => setFraisSortieUsine(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
              <div><div className="text-xs text-sub">Transport usine</div><input type="number" value={transportUsine} onChange={(e) => setTransportUsine(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
              <div><div className="text-xs text-sub">Cession Odoo / travaux ext.</div><input type="number" value={cessionOdoo} onChange={(e) => setCessionOdoo(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
              <div><div className="text-xs text-sub">Transport inter-site</div><input type="number" value={transportIntersite} onChange={(e) => setTransportIntersite(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
            </div>
          ...
          <div className="bg-surface border border-border rounded-lg p-5">
            ...
            <div>
              <div className="text-xs text-sub">Prix négocié TTC (hors carte grise)</div><input type="number" value={prixNegocie} onChange={(e) => setPrixNegocie(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" />
            </div>
            <div className="grid grid-cols-2 gap-3 mt-3">
              <div>
              ...
              {financementActif && (
                <div><div className="text-xs text-sub">Montant financé</div><input type="number" value={financementMontant} onChange={(e) => setFinancementMontant(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
              )}
            </div>
            {financementActif && (
              <div className="mt-3">
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              ...
              {rachatActif && (
                <div><div className="text-xs text-sub">Montant rachat</div><input type="number" value={rachatMontant} onChange={(e) => setRachatMontant(e.target.value)} className="w-full mt-1 border border-border rounded-md px-2 py-2 text-sm bg-[#F0FFFE]" /></div>
              )}
            </div>
            {rachatActif && (
              <div className="mt-3">
