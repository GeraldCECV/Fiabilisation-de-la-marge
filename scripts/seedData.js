...
const RAPIDO_OPTIONS_INTEGRAUX = [
  ...
  { id: "frost_control_i", nom: "Frost Control + réglage température chambre", achatHt: 3750, cessionPose: 0, prixTtc: 5000, poids: 65,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","O","-","O","-","-","-","-","-","-"]) },
  ...
  { id: "alko_comfort_heavy_i", nom: "Suspension AL-KO Comfort Drive (châssis HEAVY)", achatHt: 2175, cessionPose: 0, prixTtc: 2900, poids: 10,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","-","-","-","O","O","O","O","O","O"]) },
  { id: "attelage_profile_i", nom: "Attelage 2000 kg (profilés / 850F)", achatHt: 1065, cessionPose: 0, prixTtc: 1420, poids: 60,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","-","-","-","-","-","-","-","-","-"]) },
  { id: "attelage_integral_i", nom: "Attelage 2000 kg (Intégraux base Mercedes)", achatHt: 1770, cessionPose: 0, prixTtc: 2360, poids: 55,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","O","O","O","O","O","O","O","O","O"]) },
  { id: "sieges_aguti_i", nom: "Sièges cabine AGUTI rotatifs GIS Liner (chauffés/ventilés)", achatHt: 825, cessionPose: 0, prixTtc: 1100, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","-","-","-","-","-","-","-","O","O"]) },
  { id: "navigation_dab9_var1_i", nom: "Navigation DAB Pioneer 9'' CarPlay/Android Auto (C55i/850F)", achatHt: 788, cessionPose: 0, prixTtc: 1050, poids: 2,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","-","-","O","-","-","-","-","-","-","-","-","-","-","-"]) },
  { id: "navigation_dab9_var2_i", nom: "Navigation DAB Pioneer 9'' CarPlay/Android Auto (autres profilés/intégraux)", achatHt: 450, cessionPose: 0, prixTtc: 600, poids: 2,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","O","O","-","O","O","O","O","O","-","-","-","-","-","-"]) },
  { id: "habillage_grand_froid_i", nom: "Habillage extérieur Grand Froid", achatHt: 525, cessionPose: 0, prixTtc: 700, poids: 5,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","O","O","O","O","O","O"]) },
  { id: "baies_cabine_double_vitrage_i", nom: "Baies cabine latérales double vitrage (sauf porte chauffeur)", achatHt: 450, cessionPose: 0, prixTtc: 600, poids: 10,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","O","O","O","O","O","O","-","O","-","O","O","O"]) },
  { id: "sans_lit_cabine_fixe_i", nom: "Sans lit cabine, avec table salon pied fixe", achatHt: 1125, cessionPose: 0, prixTtc: 1500, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","-","-","-","-","-","-","-","-","-","-","-","-"]) },
  { id: "sans_lit_cabine_telescopique_i", nom: "Sans lit cabine, avec table salon pied télescopique", achatHt: 1125, cessionPose: 0, prixTtc: 1500, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","O","O","O","O","O","O","O","O","O","O","O","O"]) },
  { id: "surmatelas900_i", nom: "Sur-matelas à mémoire de forme sur lit permanent (900€)", achatHt: 675, cessionPose: 0, prixTtc: 900, poids: 6,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","-","-","O","-","O","-","-","O","O","-","-","S","-"]) },
  { id: "kit_protection_matelas150_i", nom: "Kit protection matelas (150€)", achatHt: 113, cessionPose: 0, prixTtc: 150, poids: 1.3,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","O","O","-","O","-","O","O","-","-","O","O","-","O"]) },
  { id: "kit_protection_matelas300_i", nom: "Kit protection matelas (300€)", achatHt: 225, cessionPose: 0, prixTtc: 300, poids: 2.2,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","-","-","O","-","O","-","-","O","O","-","-","O","-"]) },
  { id: "batterie_lithium150_i", nom: "Batterie cellule LITHIUM 150Ah (coupleur/séparateur/booster)", achatHt: 600, cessionPose: 0, prixTtc: 800, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","S","S","-","S","S","-","-","-","-","-","-","-","-","-"]) },
  { id: "batterie2_lithium150_i", nom: "2e batterie cellule LITHIUM 150Ah (total 300Ah)", achatHt: 1125, cessionPose: 0, prixTtc: 1500, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","O","O","O","O","O","O"]) },
  { id: "convertisseur2000w_i", nom: "Convertisseur 2000W avec coupe batterie", achatHt: 675, cessionPose: 0, prixTtc: 900, poids: 5,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","S","S","-","S","S","-","-","-","O","O","O","O","S","S"]) },
  { id: "audio_symphonie_i", nom: "Système Audio Symphonie", achatHt: 750, cessionPose: 0, prixTtc: 1000, poids: 0,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","O","O","O","O","S","S"]) },
  { id: "moquette_cellule_i", nom: "Moquette cellule", achatHt: 788, cessionPose: 0, prixTtc: 1050, poids: 9,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","-","-","-","-","-","-","-","O","O"]) },
  { id: "moquette_cellule_cabine_i", nom: "Moquette cellule et cabine", achatHt: 788, cessionPose: 0, prixTtc: 1050, poids: 11,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","O","O","O","O","-","-"]) },
  { id: "kit_moquette_cabine_i", nom: "Kit moquette cabine", achatHt: 150, cessionPose: 0, prixTtc: 200, poids: 2,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","-","-","-","-","-","-","-","-","-","-","-","-","S","S"]) },
  { id: "kit_lino_protecteur_i", nom: "Kit lino protecteur", achatHt: 150, cessionPose: 0, prixTtc: 200, poids: 2,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","O","O","O","O","O","O"]) },
  { id: "panneau_solaire150_i", nom: "Panneau solaire 150W (monté usine)", achatHt: 375, cessionPose: 0, prixTtc: 500, poids: 9,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["-","S","S","-","S","S","O","O","O","O","O","O","O","S","S"]) },
  { id: "douchette_exterieure_i", nom: "Douchette extérieure eau chaude/froide", achatHt: 150, cessionPose: 0, prixTtc: 200, poids: 1,
    compat: zipCompat(RAPIDO_INTEGRAUX_IDS, ["O","O","O","O","O","O","O","O","O","S","S","S","S","S","S"]) },
].map((o) => ({ ...o, marque: "Rapido" }));
