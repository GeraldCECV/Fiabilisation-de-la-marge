 ...
 * @param optionsHymerTtc number|null — Hymer uniquement : saisie manuelle du total TTC des options
 *   usine (catalogue trop volumineux pour être détaillé ligne à ligne). Remplace optionsChoisies :
 ...
 */
export function calculerMarge({ modele, optionsChoisies, optionsHymerTtc = null, equipementsYpocampChoisies = [], baremes, forfaits, prixNegocieTtc, financement, anneeCourante, fraisAnnexes = {}, expo = "PAS_EXPO", batterieChoix }) {
  ...
  let I27, J27, K27;
  if (optionsHymerTtc !== null && optionsHymerTtc !== undefined && optionsHymerTtc !== "") {
    K27 = Number(optionsHymerTtc) || 0;
    I27 = (K27 / 1.2) * 0.83;
    J27 = 0;
  } else {
    I27 = optionsChoisies.reduce((s, o) => s + Number(o.achat_ht || 0), 0);
    J27 = optionsChoisies.reduce((s, o) => s + Number(o.cession_pose || 0), 0);
    K27 = optionsChoisies.reduce((s, o) => s + Number(o.prix_ttc || 0), 0);
  }
