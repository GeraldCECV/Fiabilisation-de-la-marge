...
export const BATTERIE_COUTS = {
  "Camping car avec batterie": { achatHt: 0, cessionPose: 0 },
  "Batterie gel 105Ah": { achatHt: 192, cessionPose: 50 },
  "Pack 2 batteries gel 105Ah (incluant cosses et câblage supplémentaires)": { achatHt: 384, cessionPose: 150 },
};
 ...
 */
export function calculerMarge({ modele, optionsChoisies, baremes, forfaits, prixNegocieTtc, financement, anneeCourante, fraisAnnexes = {}, expo = "PAS_EXPO", batterieChoix }) {
  ...
  const I45 = provisionSav + I32 + batterie.achatHt;
  const J45 = J32 + batterie.cessionPose;
